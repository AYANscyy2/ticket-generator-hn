            ...
            <div id="ticket-div">
                <div id="left-ticket" style={leftTicketStyle}>
                    ...
                    >
                        <img
                            id="qr-code"
                            src="https://res.cloudinary.com/dscnitrourkela/image/upload/v1759913345/hacknitr/ub3lkh9cxf3vocdt7sh3.png"
                            alt="QR Code"
                        />
                        <p id="qr-code-text">
                            <em>
                                {" "}
                                Scan the Qr Code <br /> to register!
                            </em>
                        </p>
                    </div>
                    ...
                    <div id="team-details">
                        <h2
                            id="name"
                            className={currentTheme.nameClass}
                            style={{
                        ...
                        <div id="team-name-id">
                            ...
                            <h3
                                id="team-name"
                                className={currentTheme.teamClass}
                            >
                                {team}
                            </h3>
                        </div>
